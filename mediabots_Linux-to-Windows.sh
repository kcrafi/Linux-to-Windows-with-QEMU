...
link1_status=$(curl -Is https://s02.winiso.pl/files/Windows10/pl-pl_windows_10_multi_editions_version_21h2_updated_june_2022_x64_071109ed.iso | grep HTTP | cut -f2 -d" " | head -1)
link2_status=$(curl -Is https://s02.winiso.pl/files/Windows10/pl-pl_windows_10_multi_editions_version_21h2_updated_june_2022_x64_071109ed.iso | grep HTTP | cut -f2 -d" ")
#sudo wget -P /mediabots https://archive.org/download/WS2012R2/WS2012R2.ISO # Windows Server 2012 R2 
if [ $link1_status = "200" ] ; then 
	sudo wget -O /mediabots/WS2012R2.ISO https://s02.winiso.pl/files/Windows10/pl-pl_windows_10_multi_editions_version_21h2_updated_june_2022_x64_071109ed.iso
elif [ $link2_status = "200" -o $link2_status = "301" -o $link2_status = "302" ] ; then 
	sudo wget -P /mediabots https://s02.winiso.pl/files/Windows10/pl-pl_windows_10_multi_editions_version_21h2_updated_june_2022_x64_071109ed.iso
else
